...
CFLAGS_PYEMBED = ['-march=nocona', '-mtune=haswell', '-ftree-vectorize', '-fPIC', '-fstack-protector-strong', '-fno-plt', '-O3', '-flto', '-fuse-linker-plugin', '-ffat-lto-objects', '-fwrapv', '-O3']
CFLAGS_cshlib = ['-fPIC']
COMPILER_CC = 'gcc'
COMPILER_CXX = 'g++'
CPPPATH_ST = '-I%s'
...
CXXFLAGS_PYEMBED = ['-march=nocona', '-mtune=haswell', '-ftree-vectorize', '-fPIC', '-fstack-protector-strong', '-fno-plt', '-O3', '-flto', '-fuse-linker-plugin', '-ffat-lto-objects', '-fwrapv', '-O3']
...
DEFINES = ['NS3_BUILD_PROFILE_DEBUG', 'NS3_ASSERT_ENABLE', 'NS3_LOG_ENABLE', 'HAVE_SYS_IOCTL_H=1', 'HAVE_IF_NETS_H=1', 'HAVE_NET_ETHERNET_H=1', 'HAVE_PACKET_H=1', 'HAVE_ZMQ=1', 'HAVE_PROTOBUF=1', 'HAVE_SQLITE3=1', 'HAVE_IF_TUN_H=1', 'HAVE_CRYPTO=1']
DEFINES_PYEMBED = ['NDEBUG']
DEFINES_ST = '-D%s'
DEFINE_COMMENTS = {'PYTHONDIR': '', 'PYTHONARCHDIR': '', 'HAVE_PYEMBED': '', 'HAVE_GTK': '', 'HAVE_LIBXML2': '', 'HAVE_UINT128_T': '', 'HAVE___UINT128_T': '', 'INT64X64_USE_128': '', 'HAVE_STDINT_H': '', 'HAVE_INTTYPES_H': '', 'HAVE_SYS_INT_TYPES_H': '', 'HAVE_SYS_TYPES_H': '', 'HAVE_SYS_STAT_H': '', 'HAVE_DIRENT_H': '', 'HAVE_STDLIB_H': '', 'HAVE_GETENV': '', 'HAVE_SIGNAL_H': '', 'HAVE_PTHREAD_H': '', 'HAVE_RT': '', 'HAVE_SYS_IOCTL_H': '', 'HAVE_IF_NETS_H': '', 'HAVE_NET_ETHERNET_H': '', 'HAVE_IF_TUN_H': '', 'HAVE_PACKET_H': '', 'HAVE_ZMQ': '', 'HAVE_PROTOBUF': '', 'HAVE_SQLITE3': '', 'HAVE_CRYPTO': ''}
DEST_BINFMT = 'elf'
DEST_CPU = 'x86_64'
DEST_OS = 'linux'
...
ENABLE_ZMQ = True
EXAMPLE_DIRECTORIES = ['routing', 'tcp', 'stats', 'energy', 'socket', 'realtime', 'error-model', 'tutorial', 'udp', 'ipv6', 'wireless', 'traffic-control', 'naming', 'matrix-topology', 'udp-client-server']
...
INCLUDES_GTK = ['/usr/include/gtk-3.0', '/usr/include/pango-1.0', '/usr/include/glib-2.0', '/usr/lib/glib-2.0/include', '/usr/include/harfbuzz', '/usr/include/freetype2', '/usr/include/libpng16', '/usr/include/libmount', '/usr/include/blkid', '/usr/include/fribidi', '/usr/include/cairo', '/usr/include/lzo', '/usr/include/pixman-1', '/usr/include/gdk-pixbuf-2.0', '/usr/include/gio-unix-2.0', '/usr/include/cloudproviders', '/usr/include/atk-1.0', '/usr/include/at-spi2-atk/2.0', '/usr/include/dbus-1.0', '/usr/lib/dbus-1.0/include', '/usr/include/at-spi-2.0']
INCLUDES_LIBXML2 = ['/usr/include/libxml2']
INCLUDES_PYEMBED = ['/home/patricia/anaconda3/include/python3.6m']
...
LIBPATH_PYEMBED = ['/home/patricia/anaconda3/lib/python3.6/config-3.6m-x86_64-linux-gnu', '/home/patricia/anaconda3/lib']
LIBPATH_ST = '-L%s'
LIB_BOOST = []
LIB_GCRYPT = ['gcrypt', 'gpg-error']
LIB_GTK = ['gtk-3', 'gdk-3', 'z', 'pangocairo-1.0', 'pango-1.0', 'harfbuzz', 'atk-1.0', 'cairo-gobject', 'cairo', 'gdk_pixbuf-2.0', 'gio-2.0', 'gobject-2.0', 'glib-2.0']
LIB_LIBXML2 = ['xml2']
LIB_PROTOBUF = ['protobuf']
LIB_PYEMBED = ['python3.6m', 'pthread', 'dl', 'util', 'rt', 'm', 'python3.6m', 'pthread', 'dl', 'util', 'rt', 'm']
LIB_RT = ['rt']
LIB_SQLITE3 = ['sqlite3']
LIB_ST = '-l%s'
LIB_ZMQ = ['zmq']
...
LINKFLAGS_PYEMBED = ['-fPIC', '-Xlinker', '-export-dynamic']
...
NS3_EXECUTABLE_PATH = ['/home/patricia/Workspace/NIR/ns-allinone-3.29/ns-3.29/build/src/fd-net-device', '/home/patricia/Workspace/NIR/ns-allinone-3.29/ns-3.29/build/src/tap-bridge']
...
PYO = 1
PYTAG = 'cpython-36'
PYTHON = ['/home/patricia/anaconda3/bin/python']
PYTHONARCHDIR = '/usr/local/lib/python3.6/site-packages'
PYTHONDIR = '/usr/local/lib/python3.6/site-packages'
PYTHON_CONFIG = ['/home/patricia/anaconda3/bin/python3.6-config']
PYTHON_VERSION = '3.6'
...
cfg_files = ['/home/patricia/Workspace/NIR/ns-allinone-3.29/ns-3.29/build/ns3/config-store-config.h', '/home/patricia/Workspace/NIR/ns-allinone-3.29/ns-3.29/build/ns3/core-config.h']
cprogram_PATTERN = '%s'
...
define_key = ['HAVE_SYS_IOCTL_H', 'HAVE_IF_NETS_H', 'HAVE_NET_ETHERNET_H', 'HAVE_IF_TUN_H', 'HAVE_PACKET_H', 'HAVE_ZMQ', 'HAVE_PROTOBUF', 'HAVE_SQLITE3', 'HAVE_CRYPTO']
